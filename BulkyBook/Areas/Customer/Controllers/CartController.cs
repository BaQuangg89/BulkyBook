...
namespace BulkyBook.Areas.Customer.Controllers
{
    ...
    public class CartController : Controller
    {
        ...
        public async Task<IActionResult> IndexPOST()
        {
            ...
            if (user == null)
            {
                ModelState.AddModelError(string.Empty, "Verification email is emmty!");
            }
        ...
        public IActionResult SummaryPost(string stripeToken)
        {
            ...
            ShoppingCartVM.OrderHeader.PaymentStatus = SD.PaymentStatusPeding;
            ...
            if (stripeToken == null)
            {
                //Order wwill be created for delayed payment for authroized company
            ...
            return RedirectToAction("OrderConfimation", "Cart", new { id = ShoppingCartVM.OrderHeader.Id });
